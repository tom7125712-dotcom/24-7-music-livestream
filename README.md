...
5. The schedule sends a handoff request every 30 minutes at minute `17` and `47` UTC. Each run streams up to 340 minutes, reconnects if FFmpeg exits early, and waits for the previous run instead of canceling it.
